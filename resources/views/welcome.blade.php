    ...
    <div class="col">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <a href="/subjects" class="btn btn-primary">Lista de Matérias</a>
            </div>
        </div>
    </div>
    <div class="col">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <a href="/movies" class="btn btn-primary">Lista de Filmes</a>
            </div>
        </div>
    </div>
    <div class="col">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <a href="/professors" class="btn btn-primary">Lista de Professores</a>
            </div>
        </div>
    </div>
</div>
